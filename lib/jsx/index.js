...
function render() {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_toolbar2.default, { ref: 'toolbar', clickBtnHandle: this.clickToolbarBtnHandle.bind(this), selectBtnHandle: this.selectToolbarBtnHandle.bind(this), toolbarTypes: config.TOOLBAR_TYPES }),
        ...
        _react2.default.createElement(_rightmenu2.default, { ref: 'rightmenu', menuHandle: this.rightMenuClickHandle.bind(this), menuTypes: config.MENU_TYPES, nodeTypes: config.NODE_TYPES })
    );
}