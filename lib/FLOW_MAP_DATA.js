...
exports.MAP_DATA = exports.NODE_INFO = exports.NODE_TYPES_LENGTH = exports.GROUP_TYPES = exports.NODE_TYPES = exports.TOOLBAR_TYPES = exports.MENU_TYPES = undefined;
...
var MENU_TYPES = exports.MENU_TYPES = [{ key: "addGroup", title: "新建组", targets: { node: false, rootGroup: true, container: false } }, { key: "addNode", title: "新建节点", targets: { node: false, rootGroup: true, container: true } }, { key: "addArrow", title: "连接", targets: { node: true, rootGroup: false, container: false } }, { key: "reset", title: "清空画布" }, { key: "zoomin", title: "放大" }, { key: "zoomout", title: "缩小" }, { key: "zoomreset", title: "1:1" }];
...
, [{ name: 'search' }], [{ name: 'print' }], [{ name: 'json' }], [{ name: 'max' }, { name: 'reset' }]];
