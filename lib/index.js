...
var FlowMap = function () {
    ...
    _createClass(FlowMap, [{
            ...
            document.body.addEventListener("mousemove", function (e) {
                if (dragTarget) {
                    ...
                    if (dragTarget.parent && _this2.data(dragTarget.parent)['type'] == 'containerContent') {
                        _this2.refreshContainerReact(dragTarget.parent.parent);
                    }
        ...
        value: function refreshFillStyle() {
            ...
            //  this.paper.style.width = window.innerWidth + 'px'
            //  this.paper.style.height = window.innerHeight + 'px'
        ...
        value: function deserialization(data, callback) {
            ...
            this.resetPage({}, function () {
                ...
                for (var _key4 in _this6.containers) {
                    ...
                    _this6.refreshContainerReact(_this6.containers[_key4]);
                }
                ...
                for (var _key5 in arrows) {
                    ...
                    var startNode = _this6.nodes[ids[1]],
                        endNode = _this6.nodes[ids[2]];
