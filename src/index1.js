...
import GroupShape from 'zrender/src/container/Group'
...
import tplRender from './jsx/index1.js'
...
export default class FlowMap extends React.Component{
    ...
    delActiveArrow(){
      ...
      //  this.rootGroup.removeChild(this.status.activeArrow['arrow'])
        this.zr.remove(this.status.activeArrow['line'])
        this.zr.remove(this.status.activeArrow['arrow'])
